...
export function buildPlanContextPrompt(plan: UserPlan): string {
  ...
  switch (plan) {
    case "free":
      ...
      lines.push("- CANNOT: Access Managed Account features (requires Managed $50/mo plan).");
    ...
    case "pro":
      ...
      lines.push("- CANNOT: Access Managed Account portfolio features (requires Managed $50/mo).");
    ...
    case "premium":
      ...
      lines.push("- CAN: Everything in Terminal plus Managed Account, managed portfolio, and automated trade execution.");

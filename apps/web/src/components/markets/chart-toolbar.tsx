...
export function ChartToolbar({
  ...
  return (
    <div className="flex shrink-0 flex-wrap items-center gap-2 border-b border-white/6 bg-black/40 px-3 py-2">
      ...
      <TimeframeSelector value={interval} onChange={onIntervalChange} className="min-w-0 flex-1" />

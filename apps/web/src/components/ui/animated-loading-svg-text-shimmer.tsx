      ...
      >
        <path
          ...
          className={cn(
            ...
            isReady ? "opacity-100 animate-[drawStroke_1.0s_infinite]" : "opacity-0"
          )}
        />
      </svg>
    );
  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        <span 
          className="bg-clip-text text-transparent shimmer-text font-sans"
          style={{
            backgroundSize: "200% auto",
            animation: "textShimmer 0.8s ease-in-out infinite"
          }}
        >
          {text}
        </span>
        ...
        <ChevronRight 
          ...
          className={cn(
            ...
            isOpen ? "rotate-90 text-zinc-300" : "rotate-0"
          )} 
        />
      </div>
